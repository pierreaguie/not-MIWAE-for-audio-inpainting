...
if __name__ == "__main__":
    x_train = torch.load("data/big_dataset/x_train.pt", weights_only=True)
    s_train = torch.load("data/big_dataset/s_train.pt", weights_only=True)
    x_val = torch.load("data/big_dataset/x_val.pt", weights_only=True)
    s_val = torch.load("data/big_dataset/s_val.pt", weights_only=True)
